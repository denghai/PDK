...
BEGIN
	...
	SELECT @TreasureScore=Score FROM QPTreasureDBLink.QPTreasureDB.dbo.GameScoreInfo WHERE UserID=@dwUserID
	...
	BEGIN
		-- 插入锁表
		INSERT QPTreasureDBLink.QPTreasureDB.dbo.GameScoreLocker (UserID, ServerID, KindID, EnterID, EnterIP, EnterMachine) VALUES (@dwUserID, @wServerID, @wKindID, @InoutIndex, @strClientIP, @strMachineID)
		IF @@ERROR<>0
		BEGIN
			-- 错误信息
