...
BEGIN
	...
	IF @GrantScoreCount IS NULL SET @GrantScoreCount=0
	IF @GrantScoreInsure IS NULL SET @GrantScoreInsure=0
	INSERT QPTreasureDBLink.QPTreasureDB.dbo.GameScoreInfo (UserID, Score,InsureScore, RegisterIP, LastLogonIP) VALUES (@UserID, @GrantScoreCount,@GrantScoreInsure, @strClientIP, @strClientIP) 
	----------------------------------------------------------------------------------------------------
	----------------------------------------------------------------------------------------------------
