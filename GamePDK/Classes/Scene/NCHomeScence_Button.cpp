...
void NCHomeScence::init_Button()
{
    ...
    WidgetManager::addButtonCB("Button_sharePengYou",this,button_selector(NCHomeScence::Button_sharePengYou));
    WidgetManager::addButtonCB("Button_shareQuan",this,button_selector(NCHomeScence::Button_shareQuan));
...
void NCHomeScence::Button_sharePengYou(cocos2d::Ref*,WidgetUserInfo*)
{
    MissionWeiXin::Instance().shareUrlWeiXin(utility::getScriptString("NNWeiXinSharUrl"),utility::getScriptString("NNWeiXinSharTitle"),utility::getScriptString("NNPrivateTxt2"),0);
}

void NCHomeScence::Button_shareQuan(cocos2d::Ref*,WidgetUserInfo*)
{
    MissionWeiXin::Instance().shareUrlWeiXin(utility::getScriptString("NNWeiXinSharUrl"),utility::getScriptString("NNWeiXinSharTitle"),utility::getScriptString("NNPrivateTxt2"),1);
}
