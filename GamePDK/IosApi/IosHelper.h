...
public:
    ...
    //分享到微信朋友
    static void shareWithWeixinFriendTxt(const char * pTxt,const char * pDes,const char * pUrl);
    //分享到微信朋友圈
    static void shareWithWeixinCircleTxt(const char * pTxt,const char * pDes,const char * pUrl);
