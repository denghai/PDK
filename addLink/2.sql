/****** Object:  LinkedServer [QPRecordDBLink]    Script Date: 03/31/2016 03:39:02 ******/
IF  EXISTS (SELECT srv.name FROM sys.servers srv WHERE srv.server_id != 0 AND srv.name = N'QPRecordDBLink')EXEC master.dbo.sp_dropserver @server=N'QPRecordDBLink', @droplogins='droplogins'
GO
...
EXEC master.dbo.sp_serveroption @server=N'QPRecordDBLink', @optname=N'collation compatible', @optvalue=N'false'
GO
...
EXEC master.dbo.sp_serveroption @server=N'QPRecordDBLink', @optname=N'rpc', @optvalue=N'false'
GO

EXEC master.dbo.sp_serveroption @server=N'QPRecordDBLink', @optname=N'rpc out', @optvalue=N'false'
GO
